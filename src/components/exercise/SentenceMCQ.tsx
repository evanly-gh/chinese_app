...
interface SentenceMCQProps {
  exercise: Exercise;
  onAnswer: (correct: boolean) => void;
}

export function SentenceMCQ({ exercise, onAnswer }: SentenceMCQProps) {
...
const styles = StyleSheet.create({
  ...
  sentence: { fontSize: 22, textAlign: 'center', fontWeight: '500' },
  pinyin: { fontSize: 13, textAlign: 'center' },
  ttsBtn: {
    width: 40,
    height: 40,
    borderRadius: 20,
